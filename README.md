...
1. Render products in a table with id, product, category, and owner (user).
...
## Instructions
- "Use template" and run `npm i`
- fix the DEMO LINK below (use your GitHub username and the repo name)
  - [DEMO LINK](https://dsb-18.github.io/react__product-categories-practice)
